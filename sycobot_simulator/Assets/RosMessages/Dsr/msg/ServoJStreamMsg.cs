...
{
    [Serializable]
    public class ServoJStreamMsg : Message
    {
        public const string k_RosMessageName = "dsr_msgs/ServoJStream";
        ...
        public ServoJStreamMsg(double[] pos, double[] vel, double[] acc, double time)
        {
            this.pos = pos;
            this.vel = vel;
            this.acc = acc;
        ...
        public static ServoJStreamMsg Deserialize(MessageDeserializer deserializer) => new ServoJStreamMsg(deserializer);

        private ServoJStreamMsg(MessageDeserializer deserializer)
        {
