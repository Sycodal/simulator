...
{
    [Serializable]
    public class ServoLRTStreamMsg : Message
    {
        public const string k_RosMessageName = "dsr_msgs/ServoLRTStream";
        ...
        public ServoLRTStreamMsg(double[] pos, double[] vel, double[] acc, double time)
        {
            this.pos = pos;
            this.vel = vel;
            this.acc = acc;
        ...
        public static ServoLRTStreamMsg Deserialize(MessageDeserializer deserializer) => new ServoLRTStreamMsg(deserializer);

        private ServoLRTStreamMsg(MessageDeserializer deserializer)
        {
