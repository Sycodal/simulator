...
namespace RosMessageTypes.Dsr
{
    ...
    {
        public const string k_RosMessageName = "dsr_msgs/MoveBlending";
        ...
        public MoveBlendingRequest(Std.Float64MultiArrayMsg[] segment, sbyte posCnt, double[] vel, double[] acc, double time, sbyte @ref, sbyte mode, sbyte syncType)
        {
